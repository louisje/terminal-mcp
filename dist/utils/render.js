 ...
 */
export function renderTerminalToPng(terminal, options = {}) {
    const { fontFamily = 'JetBrains Mono', fontDirs: userFontDirs = [], windowChrome = true, scale = 2, } = options;
...
<circle cx="60" cy="18" r="6" fill="#28c840"/>`;
    ...
    try {
        ...
        throw new Error('PNG screenshot requires @resvg/resvg-js. Install it with: npm install @resvg/resvg-js');
    }
